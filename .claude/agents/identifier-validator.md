...
- Verify EC, RHEA, MetaCyc, ChEBI, UniProt, RefSeq, and other database identifier formats
- You can use URLs like `https://bioregistry.io/CURIE`, e.g. `https://bioregistry.io/ec-code:2.7.1.91`
- Some sites may be blocked, use general web searches when needed
...
- For reaction terms, verify RHEA IDs and EC numbers are correctly formatted
- Identify potential mapping errors or conceptual mismatches

**Ontology Term ID Validation:**
- Verify GO, ChEBI, UBERON, CL, and other ontology term ID formats
- Use appropriate search tools (like `obo-grep.pl` for GO terms) to confirm term existence
...
- Ensure gene/protein identifiers use proper formats (UniProt, RefSeq, etc.)
- Verify GO term IDs follow the GO:NNNNNNN format with 7 digits
