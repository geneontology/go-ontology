...
for perfoming over the GO ontology.

For complementary checks that are executed over GO annotations, see
[gorules](https://github.com/geneontology/go-site/blob/master/metadata/rules/)

SPARQL can be executed on a triplestore or directly on any OWL
file. The queries here are all executed on either go-edit.obo or
