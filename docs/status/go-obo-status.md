---
id: obo:go/releases/2026-08-06go.owl-statistics
ontologies:
- id: go
  version: obo:go/releases/2026-08-06go.owl
was_generated_by:
  started_at_time: '2026-08-06T06:37:44.067412'
...
partitions:
  ...
  molecular_function:
    ...
    non_deprecated_class_count: 10048
    class_count_with_text_definitions: 12864
    class_count_without_text_definitions: 0
    edge_count_by_predicate:
      rdfs:subClassOf:
        facet: rdfs:subClassOf
      ...
      RO:0002211:
        facet: RO:0002211
        filtered_count: 49
    distinct_synonym_count: 28677
    synonym_statement_count: 29830
    change_summary:
      NodeRename: 42
      EdgeDeletion: 58
      EdgeCreation: 42
