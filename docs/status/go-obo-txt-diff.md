...
```diff
--- go-lastrelease.obo	2026-05-13 06:38:15.227941069 +0000
+++ go.obo	2026-05-13 06:47:32.942856164 +0000
@@ -1,5 +1,5 @@
 format-version: 1.2
-data-version: releases/2026-03-25
+data-version: releases/2026-05-13
...
+property_value: owl:versionInfo "2026-05-13" xsd:string
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/29439" xsd:anyURI
...
+property_value: skos:narrowMatch RHEA:38399
+property_value: skos:narrowMatch RHEA:38403
+property_value: skos:narrowMatch RHEA:38407
+property_value: skos:narrowMatch RHEA:38411
+property_value: skos:narrowMatch RHEA:38415
+property_value: skos:narrowMatch RHEA:38419
+property_value: skos:narrowMatch RHEA:38423
+property_value: skos:narrowMatch RHEA:38427
+property_value: skos:narrowMatch RHEA:38431
...
+name: obsolete asparagine metabolic process
 namespace: biological_process
-def: "The chemical reactions and pathways involving asparagine, 2-amino-3-carbamoylpropanoic acid." [GOC:curators]
+def: "OBSOLETE. The chemical reactions and pathways involving asparagine, 2-amino-3-carbamoylpropanoic acid." [GOC:curators]
+comment: This term was obsoleted because it is an unnecessary grouping term.
...
+name: obsolete L-phenylalanine metabolic process
 namespace: biological_process
...
+def: "OBSOLETE. The chemical reactions and pathways involving L-phenylalanine, the L-enantiomer of 2-amino-3-phenylpropanoic acid, i.e. (2S)-2-amino-3-phenylpropanoic acid." [GOC:jsg, GOC:mah]
+comment: This term was obsoleted because it us an unnecessary grouping term.
 ...
 xref: Reactome:R-HSA-8964208 "Phenylalanine metabolism"
...
@@ -71881,22 +72499,24 @@
 ...
 [Term]
 id: GO:0006568
-name: L-tryptophan metabolic process
+name: obsolete L-tryptophan metabolic process
 namespace: biological_process
...
+def: "OBSOLETE. The chemical reactions and pathways involving tryptophan, the chiral amino acid 2-amino-3-(1H-indol-3-yl)propanoic acid." [ISBN:0198547684]
+comment: This term was obsoleted because it is an unnecessary grouping term.
...
+property_value: skos:narrowMatch RHEA:58416
...
+def: "Catalysis of the reaction: a nucleotide + H2O = a nucleoside + phosphate." [PMID:12947102, PMID:22555564]
...
-xref: RHEA:22140
 is_a: GO:0016791 ! phosphatase activity
-property_value: skos:exactMatch RHEA:22140
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/29439" xsd:anyURI
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
...
+def: "Catalysis of the reaction: a nucleoside 5'-phosphate + H2O = a nucleoside + phosphate." [EC:3.1.3.5, PMID:27907199]
...
+synonym: "5'-ribonucleotide phosphohydrolase activity" NARROW [EC:3.1.3.5]
...
+property_value: skos:exactMatch RHEA:22140
+property_value: skos:narrowMatch RHEA:12484
...
-xref: RHEA:28338
 xref: RHEA:28526
 is_a: GO:0008410 ! CoA-transferase activity
 property_value: skos:exactMatch EC:2.8.3.21
-property_value: skos:narrowMatch RHEA:28338
 property_value: skos:narrowMatch RHEA:28526
...
+is_a: GO:0016616 ! oxidoreductase activity, acting on the CH-OH group of donors, NAD or NADP as acceptor
 property_value: skos:exactMatch EC:1.1.1.215
 property_value: skos:exactMatch RHEA:16653
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
...
+xref: RHEA:23940
+is_a: GO:0016616 ! oxidoreductase activity, acting on the CH-OH group of donors, NAD or NADP as acceptor
 property_value: skos:exactMatch EC:1.1.1.69
+property_value: skos:narrowMatch RHEA:23936
+property_value: skos:narrowMatch RHEA:23940
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
...
+name: aromatic amino acid catabolic process
 namespace: biological_process
...
+def: "The chemical reactions and pathways resulting in the breakdown of an amino acid whose structure includes an aromatic ring." [GOC:curators]
...
-relationship: has_part GO:0008675 ! 2-dehydro-3-deoxy-phosphogluconate aldolase activity
...
+synonym: "protein O-linked glycosylation via N-acetyl-galactosamine" EXACT []
 xref: MetaCyc:PWY-7433
 xref: MetaCyc:PWY-7435
 xref: Reactome:R-HSA-913709 "O-linked glycosylation of mucins"
@@ -132449,6 +133405,7 @@
...
+def: "The chemical reactions and pathways resulting in the conversion of sufide to sulfite or sulfate." [MetaCyc:Sulfide-Oxidation]
...
@@ -160847,13 +161965,14 @@
 ...
 [Term]
 id: GO:0019672
-name: acetyl-CoA fermentation to butyrate
+name: obsolete acetyl-CoA fermentation to butyrate
 namespace: biological_process
-def: "The anaerobic chemical reactions and pathways resulting in the breakdown of acetyl-CoA to butyrate, yielding energy in the form of ATP. Butanoate is secreted by the cell." [MetaCyc:PWY-5676]
-xref: MetaCyc:PWY-5676
-is_a: GO:0006113 ! fermentation
-property_value: skos:exactMatch MetaCyc:PWY-5676
+def: "OBSOLETE. The anaerobic chemical reactions and pathways resulting in the breakdown of acetyl-CoA to butyrate, yielding energy in the form of ATP. Butanoate is secreted by the cell." [MetaCyc:PWY-5676]
+comment: The reason for obsoletion is that this term is a duplicate of GO:0030645 acetyl-CoA fermentation to butanoate. Butyrate and butanoate are synonyms, and both terms referenced the same MetaCyc pathway (PWY-5676).
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/29511" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32079" xsd:anyURI
+is_obsolete: true
+replaced_by: GO:0030645
...
@@ -177616,14 +178742,16 @@
 id: GO:0030645
 name: acetyl-CoA fermentation to butanoate
 namespace: biological_process
-def: "The anaerobic chemical reactions and pathways resulting in the production of acetic acid, butyric acid, and dihydrogen from acetyl-CoA; effected by some saccharolytic species of Clostridium, e.g. C. butyricum." [ISBN:0198506732, Metacyc:PWY-5676]
+def: "The anaerobic chemical reactions and pathways resulting in the breakdown of acetyl-CoA to butyrate, yielding energy in the form of ATP. Butanoate is secreted by the cell." [MetaCyc:PWY-5676]
 synonym: "butyrate fermentation" EXACT []
 synonym: "glucose catabolic process to butyrate" RELATED []
 synonym: "glucose fermentation to butyrate" RELATED []
-xref: Metacyc:PWY-5676
+xref: MetaCyc:PWY-5676
+is_a: GO:0006113 ! fermentation
 is_a: GO:0019605 ! butyrate metabolic process
 is_a: GO:0046356 ! acetyl-CoA catabolic process
-relationship: part_of GO:0006113 ! fermentation
+property_value: skos:exactMatch MetaCyc:PWY-5676
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32079" xsd:anyURI
...
@@ -209331,19 +210493,19 @@
 ...
 [Term]
 id: GO:0033499
-name: galactose catabolic process via UDP-galactose, Leloir pathway
+name: beta-D-galactose catabolic process via UDP-galactose, Leloir pathway
 namespace: biological_process
-def: "The chemical reactions and pathways resulting in the breakdown of galactose, via the intermediate UDP-galactose." [GOC:mah]
...
+relationship: part_of GO:0052699 ! ergothioneine biosynthetic process
 property_value: skos:exactMatch EC:1.14.99.50
 property_value: skos:exactMatch RHEA:42672
...
+synonym: "COPII vesicle coating" EXACT [GOC:ascb_2009, GOC:dph, GOC:tb]
 xref: Reactome:R-HSA-204005 "COPII-mediated vesicle transport"
-is_a: GO:0006901 ! vesicle coating
+is_a: GO:0006901 ! vesicle coat assembly
...
+xref: MetaCyc:PWY-7255
+xref: MetaCyc:PWY-7550
...
+property_value: skos:narrowMatch MetaCyc:PWY-7255
+property_value: skos:narrowMatch MetaCyc:PWY-7550
...
-relationship: has_part GO:0033499 ! galactose catabolic process via UDP-galactose, Leloir pathway
...
+xref: MetaCyc:PWY-8004
 ...
 is_a: GO:0016052 ! carbohydrate catabolic process
+property_value: skos:narrowMatch MetaCyc:ENTNER-DOUDOROFF-PWY
+property_value: skos:narrowMatch MetaCyc:NPGLUCAT-PWY
+property_value: skos:narrowMatch MetaCyc:PWY-2221
+property_value: skos:narrowMatch MetaCyc:PWY-8004
 created_by: dph
...
-relationship: has_part GO:0061677 ! 2-dehydro-3-deoxy-D-gluconate aldolase activity
...
+relationship: part_of GO:0052699 ! ergothioneine biosynthetic process
 property_value: skos:exactMatch EC:1.21.3.10
 property_value: skos:exactMatch RHEA:42704
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/11163" xsd:anyURI
@@ -387749,12 +389270,13 @@
...
-relationship: has_part GO:0061678 ! Entner-Doudoroff pathway
...
+name: obsolete sulfide oxidation, using sulfide:quinone oxidoreductase
 namespace: biological_process
...
+def: "OBSOLETE. A sulfide oxidation process that proceeds via the reaction catalyzed by sulfide:quinone oxidoreductase." [GOC:ew]
+comment: The reason for obsoletion is that this term represents a GO-CAM.
...
+property_value: skos:narrowMatch RHEA:27409
+property_value: skos:narrowMatch RHEA:63936
...
-is_a: GO:0099022 ! vesicle tethering
-is_a: GO:0140029 ! exocytic process
...
+name: obsolete ubiquitin-independent protein catabolic process via the multivesicular body sorting pathway
 namespace: biological_process
-def: "The chemical reactions and pathways resulting in the breakdown of a protein or peptide, via the multivesicular body (MVB) sorting pathway; proteins are sorted into MVBs, and delivered to a lysosome/vacuole for degradation. This process is independent of ubiquitination." [PMID:22547407]
...
+def: "OBSOLETE. The chemical reactions and pathways resulting in the breakdown of a protein or peptide, via the multivesicular body (MVB) sorting pathway; proteins are sorted into MVBs, and delivered to a lysosome/vacuole for degradation. This process is independent of ubiquitination." [PMID:22547407]
+comment: This term was obsoleted because it is defined negatively, and is redundant with other existing terms.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32038" xsd:anyURI
+is_obsolete: true
+replaced_by: GO:0032509
 created_by: tb
 creation_date: 2014-10-23T15:27:12Z
...
-is_a: GO:0090522 ! vesicle tethering involved in exocytosis
-relationship: part_of GO:0016081 ! synaptic vesicle docking
...
+property_value: skos:narrowMatch RHEA:38507
+property_value: skos:narrowMatch RHEA:38511
+property_value: skos:narrowMatch RHEA:38515
+property_value: skos:narrowMatch RHEA:38519
+property_value: skos:narrowMatch RHEA:38523
...
+property_value: skos:exactMatch EC:1.14.18.6
...
@@ -482037,6 +483862,30 @@
 ...
 [Term]
+id: GO:0120576
+name: 1,2-dehydro-N-beta-alanyldopamine biosynthetic process
+namespace: biological_process
+def: "The chemical reactions and pathways resulting in the formation of 1,2-dehydro-N-beta-alanyldopamine via N-beta-alanyldopamine (NBAD). In insects, these sclerotizing precursors are involved in the cross-linking of cuticular proteins hardening (sclerotizing) and pigmenting the cuticle." [PMID:19932179, PMID:32709620]
+synonym: "N-beta-alanyldopamine biosynthesis" NARROW []
+synonym: "NBAD biosynthesis" NARROW []
+is_a: GO:0046148 ! pigment biosynthetic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32029" xsd:anyURI
+created_by: sjm
+creation_date: 2026-05-07T08:02:35Z
+
+[Term]
+id: GO:0120577
+name: 1,2-dehydro-N-acetyldopamine biosynthetic process
+namespace: biological_process
+def: "The chemical reactions and pathways resulting in the formation of 1,2-dehydro-N-acetyldopamine via N-acetyldopamine (NADA). In insects, these sclerotizing precursors are involved in the cross-linking of cuticular proteins hardening (sclerotizing) and pigmenting the cuticle." [PMID:19932179, PMID:32709620]
+synonym: "N-acetyldopamine biosynthesis" NARROW []
+synonym: "NADA biosynthesis" NARROW []
+is_a: GO:0046148 ! pigment biosynthetic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32029" xsd:anyURI
+created_by: sjm
...
@@ -485270,7 +487136,7 @@
 namespace: biological_process
 def: "The chemical reactions and pathways resulting in the formation of keratan sulfate II (KS-II), O-linked via a GalNAc attached to a serine or a threonine residue in the target protein." [PMID:29340594]
 synonym: "O-linked GalNAc-keratan sulfate-II proteoglycan biosynthetic process" EXACT []
-is_a: GO:0016266 ! protein O-linked glycosylation via N-acetyl-galactosamine
+is_a: GO:0016266 ! protein O-linked glycosylation via N-acetylgalactosamine
 is_a: GO:0018146 ! keratan sulfate proteoglycan biosynthetic process
...
@@ -487253,6 +489162,16 @@
 ...
 [Term]
+id: GO:0140419
+name: cytoplasmic lattice complex
+namespace: cellular_component
+def: "A protein complex at least composed of PADI6, TLE6, NLRP14 and KHDC3 that forms fibrous structures in the mammalian ooplasm." [PMID:41845018, PMID:41917274, PMID:41986725]
+is_a: GO:0032991 ! protein-containing complex
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31998" xsd:anyURI
+created_by: pg
+creation_date: 2026-04-30T10:01:02Z
+
+[Term]
 id: GO:0140420
 ...
 namespace: biological_process
@@ -487277,6 +489196,17 @@
 creation_date: 2020-01-30T13:14:02Z
 
 [Term]
+id: GO:0140422
+name: symbiont-mediated suppression of host immunothrombosis
+namespace: biological_process
+def: "A process by which a symbiont inhibits or disrupts thrombosis formation induced by host immune cells in response to a pathogenic symbiont. Microbial-associated molecular patterns (MAMPs) are recognized by host signaling receptors, leading to platelet activation. The blood clot formed creates a physical barrier that prevent symbiont dessimination, traps and kills pathogens." [PMID:24278414, PMID:40973015, PMID:42049611]
+synonym: "symbiont-mediated suppression of host thrombin-induced platelet aggregation" RELATED []
+is_a: GO:0052031 ! symbiont-mediated perturbation of host defense response
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31936" xsd:anyURI
+created_by: pg
+creation_date: 2026-05-05T13:07:35Z
+
+[Term]
 id: GO:0140423
 name: effector-mediated suppression of host pattern-triggered immunity signaling
 namespace: biological_process
@@ -487292,6 +489222,17 @@
 creation_date: 2020-02-03T09:50:33Z
 
 [Term]
+id: GO:0140424
+name: symbiont-mediated activation of blood coagulation, intrinsic pathway
+namespace: biological_process
+def: "A process in which a symbiont initiates, promotes, or enhances blood coagulation in another organism by activation of the intrinsic pathway. A common mechanism is the triggering the activity of host coagulation Factor XIIa (F12), one of the contact activation system (CAS) components, which consists of factor XII (FXII), prekallikrein (PK), and high molecular weight kininogen (HK). FXIIa instigates the coagulation cascade by cutting factor XI (FXI)." [PMID:17142774, PMID:24910020, PMID:29619369]
+is_a: GO:0044068 ! symbiont-mediated perturbation of host cellular process
+is_a: GO:0052031 ! symbiont-mediated perturbation of host defense response
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31937" xsd:anyURI
+created_by: pg
+creation_date: 2026-05-05T13:33:45Z
+
+[Term]
 id: GO:0140425
 name: galactose import across plasma membrane
 namespace: biological_process
@@ -487318,6 +489259,22 @@
 creation_date: 2020-02-11T11:08:57Z
 
 [Term]
+id: GO:0140427
+name: crotonobetainyl-CoA hydratase activity
+namespace: molecular_function
+def: "Catalysis of the reaction: (R)-carnitinyl-CoA = crotonobetainyl-CoA + H2O." [RHEA:28338]
+xref: EC:4.2.1.149
+xref: MetaCyc:CARNDETRU-RXN
+xref: RHEA:28338
+is_a: GO:0008410 ! CoA-transferase activity
+property_value: skos:exactMatch EC:4.2.1.149
+property_value: skos:exactMatch MetaCyc:CARNDETRU-RXN
+property_value: skos:exactMatch RHEA:28338
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/21870" xsd:anyURI
+created_by: pg
...
@@ -502888,6 +504907,7 @@
 ...
 is_a: GO:0170039 ! proteinogenic amino acid metabolic process
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/23268" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31996" xsd:anyURI
 created_by: ew
...
@@ -502926,6 +504950,7 @@
 is_a: GO:0006520 ! amino acid metabolic process
 is_a: GO:0019752 ! carboxylic acid metabolic process
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/23269" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31996" xsd:anyURI
 created_by: ew
...
+name: obsolete alpha-amino acid metabolic process
 namespace: biological_process
...
+name: obsolete alpha-amino acid catabolic process
 namespace: biological_process
-def: "The chemical reactions and pathways resulting in the breakdown of an alpha-amino acid." [GOC:TermGenie]
+def: "OBSOLETE. The chemical reactions and pathways resulting in the breakdown of an alpha-amino acid." [GOC:TermGenie]
+comment: The reason for obsoletion is that this term was an unnecessary grouping term.
...
+name: obsolete alpha-amino acid biosynthetic process
 namespace: biological_process
-def: "The chemical reactions and pathways resulting in the formation of an alpha-amino acid." [GOC:TermGenie]
+def: "OBSOLETE. The chemical reactions and pathways resulting in the formation of an alpha-amino acid." [GOC:TermGenie]
+comment: The reason for obsoletion is that this term was an unnecessary grouping term and more specific terms were created.
...
@@ -581780,35 +583631,23 @@
 ...
 [Term]
 id: GO:1904122
-name: positive regulation of fatty acid beta-oxidation by octopamine signaling pathway
+name: obsolete positive regulation of fatty acid beta-oxidation by octopamine signaling pathway
 namespace: biological_process
-def: "An octopamine signaling pathway that results in positive regulation of fatty acid beta-oxidation." [GO_REF:0000063, GOC:dph, GOC:kmv, GOC:TermGenie, PMID:24120942]
-synonym: "activation of fatty acid beta-oxidation by octopamine signaling pathway" NARROW [GOC:TermGenie]
-synonym: "stimulation of fatty acid beta-oxidation by octopamine signaling pathway" NARROW [GOC:TermGenie]
-synonym: "up regulation of fatty acid beta-oxidation by octopamine signaling pathway" EXACT [GOC:TermGenie]
-synonym: "up-regulation of fatty acid beta-oxidation by octopamine signaling pathway" EXACT [GOC:TermGenie]
-synonym: "upregulation of fatty acid beta-oxidation by octopamine signaling pathway" EXACT [GOC:TermGenie]
...
+def: "OBSOLETE. An octopamine signaling pathway that results in positive regulation of fatty acid beta-oxidation." [GO_REF:0000063, GOC:dph, GOC:kmv, GOC:TermGenie, PMID:24120942]
+comment: The reason for obsoletion is that this term represents a GO-CAM model (an upstream signaling event that positively regulates fatty acid beta-oxidation), which is better captured as a causal model in GO-CAM rather than as a standard GO term.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32064" xsd:anyURI
+is_obsolete: true
 created_by: kmv
 creation_date: 2015-04-08T21:03:13Z
 
 [Term]
 id: GO:1904123
-name: positive regulation of fatty acid beta-oxidation by serotonin receptor signaling pathway
+name: obsolete positive regulation of fatty acid beta-oxidation by serotonin receptor signaling pathway
 namespace: biological_process
-def: "A serotonin receptor signaling pathway that results in positive regulation of fatty acid beta-oxidation." [GO_REF:0000063, GOC:dph, GOC:kmv, GOC:TermGenie, PMID:24120942]
-synonym: "activation of fatty acid beta-oxidation by serotonin receptor signaling pathway" NARROW [GOC:TermGenie]
-synonym: "stimulation of fatty acid beta-oxidation by serotonin receptor signaling pathway" NARROW [GOC:TermGenie]
-synonym: "up regulation of fatty acid beta-oxidation by serotonin receptor signaling pathway" EXACT [GOC:TermGenie]
-synonym: "up-regulation of fatty acid beta-oxidation by serotonin receptor signaling pathway" EXACT [GOC:TermGenie]
-synonym: "upregulation of fatty acid beta-oxidation by serotonin receptor signaling pathway" EXACT [GOC:TermGenie]
-is_a: GO:0007210 ! serotonin receptor signaling pathway
-is_a: GO:0032000 ! positive regulation of fatty acid beta-oxidation
-intersection_of: GO:0007210 ! serotonin receptor signaling pathway
-intersection_of: positively_regulates GO:0006635 ! fatty acid beta-oxidation
+def: "OBSOLETE. A serotonin receptor signaling pathway that results in positive regulation of fatty acid beta-oxidation." [GO_REF:0000063, GOC:dph, GOC:kmv, GOC:TermGenie, PMID:24120942]
+comment: The reason for obsoletion is that this term represents a GO-CAM model (an upstream signaling event that positively regulates fatty acid beta-oxidation), which is better captured as a causal model in GO-CAM rather than as a standard GO term.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32064" xsd:anyURI
+is_obsolete: true
 created_by: kmv
 creation_date: 2015-04-08T21:03:20Z
...
+replaced_by: GO:0031998
 ...
 [Term]
 id: GO:1904736
-name: negative regulation of fatty acid beta-oxidation using acyl-CoA dehydrogenase
+name: obsolete negative regulation of fatty acid beta-oxidation using acyl-CoA dehydrogenase
 namespace: biological_process
-def: "Any process that stops, prevents or reduces the frequency, rate or extent of fatty acid beta-oxidation using acyl-CoA dehydrogenase." [GO_REF:0000058, GOC:TermGenie, PMID:25416781]
+def: "OBSOLETE. Any process that stops, prevents or reduces the frequency, rate or extent of fatty acid beta-oxidation using acyl-CoA dehydrogenase." [GO_REF:0000058, GOC:TermGenie, PMID:25416781]
+comment: This term was obsoleted because it represents a specific pathway variant.
 synonym: "down regulation of fatty acid beta-oxidation using acyl-CoA dehydrogenase" EXACT [GOC:TermGenie]
 synonym: "down-regulation of fatty acid beta-oxidation using acyl-CoA dehydrogenase" EXACT [GOC:TermGenie]
...
+is_obsolete: true
+replaced_by: GO:0031999
 created_by: lb
 creation_date: 2015-10-15T08:14:57Z
 
 [Term]
 id: GO:1904737
-name: positive regulation of fatty acid beta-oxidation using acyl-CoA dehydrogenase
+name: obsolete positive regulation of fatty acid beta-oxidation using acyl-CoA dehydrogenase
 namespace: biological_process
-def: "Any process that activates or increases the frequency, rate or extent of fatty acid beta-oxidation using acyl-CoA dehydrogenase." [GO_REF:0000058, GOC:TermGenie, PMID:25416781]
+def: "OBSOLETE. Any process that activates or increases the frequency, rate or extent of fatty acid beta-oxidation using acyl-CoA dehydrogenase." [GO_REF:0000058, GOC:TermGenie, PMID:25416781]
+comment: This term was obsoleted because it represents a pathway variant.
 synonym: "activation of fatty acid beta-oxidation using acyl-CoA dehydrogenase" NARROW [GOC:TermGenie]
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31932" xsd:anyURI
+is_obsolete: true
+replaced_by: GO:0032000
 created_by: lb
 creation_date: 2015-10-15T08:15:03Z
...
@@ -623635,16 +625459,13 @@
 ...
 [Term]
 id: GO:1990456
-name: mitochondrion-endoplasmic reticulum membrane tethering
+name: obsolete mitochondrion-endoplasmic reticulum membrane tethering
 namespace: biological_process
-def: "The attachment of a mitochondrion and an endoplasmic reticulum via molecular tethers that physically bridge their respective membranes and attach them to each other. The tethering may facilitate exchange of metabolites between the organelles." [PMID:19556461, PMID:27875684]
-synonym: "mitochondrion-endoplasmic reticulum attachment" EXACT []
-synonym: "mitochondrion-endoplasmic reticulum tethering" EXACT []
-synonym: "mitochondrion-ER attachment" EXACT []
-synonym: "mitochondrion-ER membrane tethering" EXACT []
-synonym: "mitochondrion-ER tethering" EXACT []
-is_a: GO:0016043 ! cellular component organization
-is_a: GO:0140056 ! organelle localization by membrane tethering
+def: "OBSOLETE. The attachment of a mitochondrion and an endoplasmic reticulum via molecular tethers that physically bridge their respective membranes and attach them to each other. The tethering may facilitate exchange of metabolites between the organelles." [PMID:19556461, PMID:27875684]
+comment: The reason for obsoletion is that this term represents a molecular function. Consider reannotating to GO:0140474 'mitochondrion-endoplasmic reticulum membrane tether activity'.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31875" xsd:anyURI
+is_obsolete: true
+consider: GO:0140474
 created_by: mcc
 creation_date: 2014-08-14T13:32:30Z
...
+namespace: biological_process
+def: "A venom-mediated activation of inflammatory response that triggers release of an inflammatory mediator in another organism. Inflammatory mediators include cytokines or interleukins." [PMID:26072684, PMID:32024243]
+synonym: "envenomation resulting in positive regulation of production of molecular mediator involved in inflammatory response in another organism" EXACT []
