...
```diff
--- go-lastrelease.obo	2026-09-26 05:33:45.951104302 +0000
+++ go.obo	2026-09-26 05:41:46.735242851 +0000
@@ -1,5 +1,5 @@
 format-version: 1.2
-data-version: releases/2026-07-26
+data-version: releases/2026-09-26
...
+property_value: owl:versionInfo "2026-09-26" xsd:string
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32608" xsd:anyURI
 created_by: krc
...
+relationship: part_of GO:7770127 ! cytosolic protein biosynthetic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32629" xsd:anyURI
 created_by: hjd
...
+xref: RHEA:87175
 ...
 property_value: skos:exactMatch EC:3.6.1.7
 property_value: skos:exactMatch RHEA:14965
+property_value: skos:narrowMatch RHEA:87159
+property_value: skos:narrowMatch RHEA:87163
+property_value: skos:narrowMatch RHEA:87171
+property_value: skos:narrowMatch RHEA:87175
...
+property_value: skos:narrowMatch RHEA:87183
...
+property_value: skos:narrowMatch RHEA:26510
+property_value: skos:narrowMatch RHEA:26550
...
+property_value: skos:narrowMatch RHEA:37231
...
+property_value: skos:narrowMatch RHEA:87335
+property_value: skos:narrowMatch RHEA:87339
+property_value: skos:narrowMatch RHEA:87343
+property_value: skos:narrowMatch RHEA:87347
+property_value: skos:narrowMatch RHEA:87407
...
+xref: RHEA:40435
 ...
 property_value: skos:exactMatch EC:3.1.1.5
 property_value: skos:exactMatch RHEA:15177
+property_value: skos:narrowMatch RHEA:40435
...
+name: helical-bundle zippering fusogenic activity
 namespace: molecular_function
 alt_id: GO:0005485
 alt_id: GO:0005486
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31789" xsd:anyURI
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/21578" xsd:anyURI
...
+relationship: part_of GO:0160307 ! protein biosynthetic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32629" xsd:anyURI
...
+xref: RHEA:87155
 ...
 property_value: skos:exactMatch EC:2.1.1.9
 property_value: skos:exactMatch RHEA:18277
+property_value: skos:narrowMatch RHEA:87155
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
...
+xref: RHEA:67956
 ...
 property_value: skos:broadMatch MetaCyc:2-HALOACID-DEHALOGENASE-RXN
 property_value: skos:exactMatch EC:3.8.1.2
 property_value: skos:exactMatch RHEA:11192
+property_value: skos:narrowMatch RHEA:67956
...
+def: "Catalysis of the reaction: methylglyoxal + H2O = D-lactate + H+." [PMID:21696459, PMID:7848303, RHEA:27754]
...
+name: L-rhamnose catabolic process
 namespace: biological_process
...
+def: "The chemical reactions and pathways resulting in the breakdown of L-rhamnose, the hexose 6-deoxy-L-mannose." [ISBN:0198506732]
+synonym: "rhamnose breakdown" BROAD []
+synonym: "rhamnose catabolic process" BROAD []
+synonym: "rhamnose catabolism" BROAD []
+synonym: "rhamnose degradation" BROAD []
...
+synonym: "transsulfuration" NARROW []
...
+property_value: skos:broadMatch MetaCyc:PWY-801
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31702" xsd:anyURI
...
+name: obsolete transsulfuration
 namespace: biological_process
...
+def: "OBSOLETE. The interconversion of homocysteine and cysteine via cystathionine. In contrast with enteric bacteria and mammals, Saccharomyces cerevisiae has two transsulfuration pathways employing two separate sets of enzymes." [MetaCyc:PWY-801]
+comment: This term was obsoleted because it represents two pathways, depending on the direction of the activities: L-homocysteine biosynthesis (GO:0071269) and L-cysteine biosynthesis (GO:0019344).
 synonym: "homocysteine-cysteine interconversion" NARROW []
...
+comment: The reason for obsoletion is that this term represents the same pathway as 'de novo' NAD+ biosynthetic process.
 ...
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31022" xsd:anyURI
 is_obsolete: true
-replaced_by: GO:0034354
+replaced_by: GO:0034628
...
+name: obsolete nicotinamide nucleotide biosynthetic process
 namespace: biological_process
...
+def: "OBSOLETE. The chemical reactions and pathways resulting in the formation of nicotinamide nucleotides, any nucleotide that contains combined nicotinamide." [GOC:curators]
...
-is_a: GO:0019363 ! pyridine nucleotide biosynthetic process
-is_a: GO:0046496 ! nicotinamide nucleotide metabolic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32583" xsd:anyURI
+is_obsolete: true
...
+synonym: "D-galactose catabolic process" NARROW []
 synonym: "galactose breakdown" EXACT []
 synonym: "galactose catabolism" EXACT []
 synonym: "galactose degradation" EXACT []
+synonym: "L-galactose catabolic process" NARROW []
+xref: MetaCyc:PWY-6693
+xref: MetaCyc:PWY-7568
 is_a: GO:0006012 ! galactose metabolic process
 is_a: GO:0019320 ! hexose catabolic process
+property_value: skos:narrowMatch MetaCyc:PWY-6693
+property_value: skos:narrowMatch MetaCyc:PWY-7568
...
+name: obsolete non-phosphorylated glucose catabolic process
 namespace: biological_process
...
+property_value: skos:narrowMatch RHEA:87411
...
+xref: MetaCyc:PWY-6599
+xref: MetaCyc:PWY-6618
+xref: MetaCyc:PWY-6620
 is_a: GO:0006177 ! GMP biosynthetic process
 is_a: GO:0106380 ! purine ribonucleotide salvage
+property_value: skos:narrowMatch MetaCyc:PWY-6599
+property_value: skos:narrowMatch MetaCyc:PWY-6618
+property_value: skos:narrowMatch MetaCyc:PWY-6620
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/21578" xsd:anyURI
...
+xref: MetaCyc:PWY-6609
+xref: MetaCyc:PWY-6611
 is_a: GO:0006188 ! IMP biosynthetic process
 is_a: GO:0106380 ! purine ribonucleotide salvage
+property_value: skos:broadMatch MetaCyc:PWY-6610
+property_value: skos:narrowMatch MetaCyc:PWY-6609
+property_value: skos:narrowMatch MetaCyc:PWY-6611
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/21578" xsd:anyURI
...
+xref: MetaCyc:SALVPURINE2-PWY
 ...
 is_a: GO:0106380 ! purine ribonucleotide salvage
+property_value: skos:exactMatch MetaCyc:SALVPURINE2-PWY
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/21578" xsd:anyURI
...
+def: "Combining with an MHC class I protein complex and transmitting the signal from one side of the membrane to the other to initiate a change in cell activity. Class I here refers to classical class I molecules." [GOC:add, GOC:signaling, ISBN:0781735149]
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32284" xsd:anyURI
...
+synonym: "mitochondrial protein anabolism" BROAD []
+synonym: "mitochondrial protein biosynthesis" BROAD []
+synonym: "mitochondrial protein formation" BROAD []
+synonym: "mitochondrial protein synthesis" BROAD []
...
+relationship: part_of GO:7770126 ! mitochondrial protein biosynthetic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32629" xsd:anyURI
...
+name: D-galactose catabolic process to D-galactonate
 namespace: biological_process
...
+def: "The chemical reactions and pathways resulting in the breakdown of D-galactose to D-galactonate." [MetaCyc:GALDEG-PWY]
...
+property_value: skos:exactMatch MetaCyc:GALDEG-PWY
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32647" xsd:anyURI
 
 [Term]
 id: GO:0033499
-name: beta-D-galactose catabolic process via UDP-galactose, Leloir pathway
...
+property_value: skos:narrowMatch RHEA:87475
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/29544" xsd:anyURI
...
+xref: RHEA:51960
 ...
 property_value: skos:exactMatch EC:4.8.1.2
 property_value: skos:exactMatch RHEA:11316
+property_value: skos:narrowMatch RHEA:28614
+property_value: skos:narrowMatch RHEA:51960
...
+name: mRNA 5'-triphosphate diphosphatase activity
 namespace: molecular_function
...
+def: "Catalysis of the reaction: a 5'-end triphospho-ribonucleoside in mRNA + H2O = a 5'-end phospho-ribonucleoside in mRNA + diphosphate + H+." [PMID:17612492, PMID:18202662, RHEA:78683]
+synonym: "mRNA 5'-diphosphatase activity" EXACT []
...
+property_value: skos:exactMatch RHEA:78683
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/23401" xsd:anyURI
...
+name: obsolete 'de novo' NAD+ biosynthetic process from L-tryptophan
 namespace: biological_process
-def: "The chemical reactions and pathways resulting in the formation of nicotinamide adenine dinucleotide (NAD+), beginning with the catabolism of L-tryptophan into the precursor quinolinate. NAD+ is a coenzyme that interconverts with its reduced form, NADH, in many redox and catabolic reactions." [PMID:17161604]
+def: "OBSOLETE. The chemical reactions and pathways resulting in the formation of nicotinamide adenine dinucleotide (NAD+), beginning with the catabolism of L-tryptophan into the precursor quinolinate. NAD+ is a coenzyme that interconverts with its reduced form, NADH, in many redox and catabolic reactions." [PMID:17161604]
+comment: This term was obsoleted because it represents a specific pathway.
...
+name: 'de novo' NAD+ biosynthetic process
 namespace: biological_process
 alt_id: GO:0019355
-def: "The chemical reactions and pathways resulting in the formation of nicotinamide adenine dinucleotide (NAD+), beginning with the catabolism of L-aspartate into the precursor quinolinate. NAD+ is a coenzyme that interconverts with its reduced form, NADH, in many redox and catabolic reactions." [GOC:curators]
-comment: This pathway is found in bacteria, Archaea and may also occur in plants.
-synonym: "'de novo' NAD biosynthetic process from aspartate" BROAD []
-synonym: "'de novo' NAD biosynthetic process from L-aspartate" EXACT []
+def: "The chemical reactions and pathways resulting in the formation of nicotinamide adenine dinucleotide (NAD+), beginning with the catabolism of L-aspartate (in bacteria and in Archaea) or L-tryptophan (in eukaryotes) into the precursor quinolinate. NAD+ is a coenzyme that interconverts with its reduced form, NADH, in many redox and catabolic reactions." [PMID:17161604]
+synonym: "'de novo' NAD biosynthetic process from aspartate" NARROW []
+synonym: "'de novo' NAD biosynthetic process from L-aspartate" NARROW []
+synonym: "'de novo' NAD biosynthetic process from L-tryptophan" NARROW []
+synonym: "'de novo' NAD+ biosynthetic process from L-aspartate" NARROW []
+synonym: "'de novo' NAD+ biosynthetic process from L-tryptophan" NARROW []
...
+synonym: "kynurenine pathway" BROAD []
+synonym: "nicotinamide nucleotide anabolism from aspartate" NARROW []
+synonym: "nicotinamide nucleotide biosynthetic process from aspartate" NARROW []
+synonym: "nicotinamide nucleotide formation from aspartate" NARROW []
+synonym: "nicotinamide nucleotide synthesis from aspartate" NARROW []
+xref: MetaCyc:NADSYN-PWY
+xref: MetaCyc:PWY-5653
 xref: MetaCyc:PWY-8277
 xref: MetaCyc:PWY-8352
 xref: MetaCyc:PYRIDNUCSYN-PWY
-is_a: GO:0006531 ! aspartate metabolic process
 is_a: GO:0009435 ! NAD+ biosynthetic process
-is_a: GO:0170039 ! proteinogenic amino acid metabolic process
+property_value: skos:narrowMatch MetaCyc:NADSYN-PWY
+property_value: skos:narrowMatch MetaCyc:PWY-5653
 property_value: skos:narrowMatch MetaCyc:PWY-8277
 property_value: skos:narrowMatch MetaCyc:PWY-8352
 property_value: skos:narrowMatch MetaCyc:PYRIDNUCSYN-PWY
...
+name: obsolete microtubule anchoring at spindle pole body
 namespace: biological_process
...
+def: "OBSOLETE. Any process in which a microtubule is maintained in a specific location in a cell by attachment to a spindle pole body. Microtubules attach to spindle pole bodies at the minus end." [GOC:mah, PMID:17486116]
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32155" xsd:anyURI
+is_obsolete: true
+consider: GO:7770121
...
+name: regulation of L-rhamnose catabolic process
 namespace: biological_process
...
+def: "Any process that modulates the frequency, rate or extent of the chemical reactions and pathways resulting in the breakdown of L-rhamnose, the hexose 6-deoxy-L-mannose." [GOC:jl]
+synonym: "regulation of rhamnose breakdown" BROAD []
+synonym: "regulation of rhamnose catabolic process" BROAD []
+synonym: "regulation of rhamnose catabolism" BROAD []
+synonym: "regulation of rhamnose degradation" BROAD []
 is_a: GO:0043470 ! regulation of carbohydrate catabolic process
...
+intersection_of: regulates GO:0019301 ! L-rhamnose catabolic process
+relationship: regulates GO:0019301 ! L-rhamnose catabolic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32647" xsd:anyURI
...
+xref: RHEA:30783
 ...
 property_value: skos:exactMatch EC:1.2.99.8
 property_value: skos:exactMatch RHEA:36047
+property_value: skos:narrowMatch RHEA:30783
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
...
+xref: MetaCyc:PWY-6605
+xref: MetaCyc:PWY-6619
 is_a: GO:0006167 ! AMP biosynthetic process
 is_a: GO:0106380 ! purine ribonucleotide salvage
+property_value: skos:broadMatch MetaCyc:PWY-6610
+property_value: skos:narrowMatch MetaCyc:P121-PWY
+property_value: skos:narrowMatch MetaCyc:PWY-6605
+property_value: skos:narrowMatch MetaCyc:PWY-6619
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/21578" xsd:anyURI
 created_by: jl
...
+name: voltage-gated ion channel clustering
 namespace: biological_process
...
+def: "The process in which voltage-gated ion channels become localized together at high density in distinct subcellular domains of the plasma membrane, such as the axon initial segment, the node of Ranvier, the cardiomyocyte intercalated disc, or the neuromuscular junction." [PMID:11456440, PMID:24210426]
+synonym: "neuronal ion channel clustering" RELATED []
 is_a: GO:0061024 ! membrane organization
-relationship: part_of GO:0042551 ! neuron maturation
+is_a: GO:0072657 ! protein localization to membrane
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32170" xsd:anyURI
...
+is_a: GO:0045161 ! voltage-gated ion channel clustering
...
+name: obsolete nicotinamide nucleotide metabolic process
 namespace: biological_process
...
+def: "OBSOLETE. The chemical reactions and pathways involving nicotinamide nucleotides, any nucleotide that contains combined nicotinamide." [ISBN:0198506732]
+comment: This term was obsoleted because it is an unnecessary grouping term.
...
-xref: EC:3.5.3.21
+def: "Catalysis of the reaction: methylenediurea + 2 H2O + 2 H+ = urea + formaldehyde + 2 NH4+ + CO2." [RHEA:15929]
+synonym: "methylenediurea amidohydrolase activity" EXACT []
+synonym: "methylenediurea aminohydrolase activity" RELATED []
+synonym: "methylenediurease activity" RELATED []
+xref: EC:3.5.1.141
...
-property_value: skos:exactMatch EC:3.5.3.21
+property_value: skos:exactMatch EC:3.5.1.141
 property_value: skos:exactMatch RHEA:15929
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32600" xsd:anyURI
...
+property_value: skos:narrowMatch RHEA:76495
+property_value: skos:narrowMatch RHEA:76547
+property_value: skos:narrowMatch RHEA:76551
+property_value: skos:narrowMatch RHEA:87255
+property_value: skos:narrowMatch RHEA:87259
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
...
+property_value: skos:narrowMatch RHEA:86783
+property_value: skos:narrowMatch RHEA:86787
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/30193" xsd:anyURI
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31474" xsd:anyURI
...
+comment: The reason for obsoletion is that this term restates an existing molecular function, GO:0004832 valine-tRNA ligase activity, and adds nothing beyond it. Gene products should be annotated to that molecular function; the biological process is covered by GO:7770128 tRNA aminoacylation for cytosolic protein translation.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/15375" xsd:anyURI
+is_obsolete: true
+replaced_by: GO:7770128
 created_by: dph
...
+name: obsolete glucose catabolic process to pyruvate
 namespace: biological_process
-def: "The chemical reactions and pathways resulting in the breakdown of glucose, with the production of pyruvate." [GOC:dph]
+def: "OBSOLETE. The chemical reactions and pathways resulting in the breakdown of glucose, with the production of pyruvate." [GOC:dph]
+comment: This term was obsoleted because it represents the same process as glycolysis ; GO:0006096.
...
+synonym: "regulation of mitochondrial protein anabolism" BROAD [GOC:mah]
+synonym: "regulation of mitochondrial protein biosynthesis" BROAD [GOC:mah]
+synonym: "regulation of mitochondrial protein formation" BROAD [GOC:mah]
+synonym: "regulation of mitochondrial protein synthesis" BROAD [GOC:mah]
...
+synonym: "negative regulation of mitochondrial protein anabolism" BROAD [GOC:mah]
+synonym: "negative regulation of mitochondrial protein biosynthesis" BROAD [GOC:mah]
+synonym: "negative regulation of mitochondrial protein formation" BROAD [GOC:mah]
+synonym: "negative regulation of mitochondrial protein synthesis" BROAD [GOC:mah]
...
+synonym: "positive regulation of mitochondrial protein anabolism" BROAD [GOC:mah]
+synonym: "positive regulation of mitochondrial protein biosynthesis" BROAD [GOC:mah]
+synonym: "positive regulation of mitochondrial protein formation" BROAD [GOC:mah]
+synonym: "positive regulation of mitochondrial protein synthesis" BROAD [GOC:mah]
...
+relationship: part_of GO:0036258 ! multivesicular body assembly
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31770" xsd:anyURI
 created_by: mah
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32594" xsd:anyURI
 created_by: mah
...
+property_value: skos:broadMatch MetaCyc:PWY-801
+property_value: skos:narrowMatch MetaCyc:PWY-5344
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31510" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31702" xsd:anyURI
 created_by: mah
...
+relationship: has_part GO:0070676 ! intralumenal vesicle formation
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31770" xsd:anyURI
 created_by: mah
...
+property_value: skos:narrowMatch RHEA:87091
+property_value: skos:narrowMatch RHEA:87095
+property_value: skos:narrowMatch RHEA:87111
+property_value: skos:narrowMatch RHEA:87115
...
-is_a: GO:1905749 ! regulation of endosome to plasma membrane protein transport
+is_a: GO:1903076 ! regulation of protein localization to plasma membrane
+is_a: GO:2001135 ! regulation of endocytic recycling
 intersection_of: GO:0065007 ! biological regulation
...
@@ -459669,13 +460181,13 @@
 ...
 [Term]
 id: GO:0099638
-name: endosome to plasma membrane protein transport
+name: obsolete endosome to plasma membrane protein transport
 namespace: biological_process
-def: "The directed movement of proteins from the endosome to the plasma membrane in transport vesicles." [GOC:dos]
-is_a: GO:0006886 ! intracellular protein transport
...
+def: "OBSOLETE. The directed movement of proteins from the endosome to the plasma membrane in transport vesicles." [GOC:dos]
+comment: The reason for obsoletion is that this term unnecessarily specified protein cargo, and no biologically meaningful sibling for non-protein cargo could be justified, so it was merged up into GO:0032456 endocytic recycling.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31237" xsd:anyURI
+is_obsolete: true
...
-is_a: GO:0099638 ! endosome to plasma membrane protein transport
...
+property_value: skos:broadMatch MetaCyc:PWY-7224
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/21578" xsd:anyURI
 created_by: hjd
...
+property_value: skos:narrowMatch RHEA:27506
...
+property_value: skos:narrowMatch RHEA:87099
+property_value: skos:narrowMatch RHEA:87103
+property_value: skos:narrowMatch RHEA:87107
+property_value: skos:narrowMatch RHEA:87351
...
+name: obsolete cargo receptor ligand activity
 namespace: molecular_function
-def: "The activity of a gene product that interacts with a cargo receptor and initiates endocytosis." [PMID:15797858]
+def: "OBSOLETE. The activity of a gene product that interacts with a cargo receptor and initiates endocytosis." [PMID:15797858]
+comment: The reason for obsoletion is that this term represents a GO-CAM model and describes a target gene rather than an activity
 synonym: "cargo" RELATED []
 xref: Reactome:R-HSA-3000074 "TCN2 binds RCbl in the circulation"
 xref: Reactome:R-HSA-3000120 "CBLIF binds RCbl"
 xref: Reactome:R-HSA-3132759 "TCN1 binds RCbl"
-is_a: GO:0005515 ! protein binding
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/17391" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32466" xsd:anyURI
+is_obsolete: true
+consider: GO:0031419
 created_by: pg
...
+synonym: "CoA phosphatase activity" EXACT []
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32636" xsd:anyURI
+created_by: pg
...
@@ -491106,12 +491695,13 @@
 ...
 namespace: molecular_function
-def: "A GTPase activity that mediates the joining of two lipid bilayers to form a single membrane." [PMID:29663589]
+def: "The activity of joining two lipid bilayers to form a single membrane by GTP-driven oligomerization." [PMID:21368113, PMID:28114303, PMID:29663589, PMID:36057374]
+comment: This activity is carried out by dynamin-related GTPases such as the mitofusins and atlastin, which oligomerize across the two membranes in a nucleotide-dependent manner and then undergo a GTP hydrolysis-coupled conformational change that pulls the bilayers together.
 synonym: "membrane fusion GTPase activity" EXACT []
-is_a: GO:0003924 ! GTPase activity
 is_a: GO:0140522 ! fusogenic activity
 relationship: part_of GO:0061025 ! membrane fusion
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/19942" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31789" xsd:anyURI
 created_by: pg
...
+name: MCM double hexamer assembly at replication origin
 namespace: biological_process
...
+def: "The multistep protein-DNA complex assembly process in which two MCM2-7 complexes are successively loaded onto duplex DNA at a replication origin to form a head-to-head double hexamer. The process begins when origin-bound ORC and Cdc6 (Cdc18 in fission yeast) recruit a Cdt1-bound MCM2-7 hexamer to the origin, proceeds through a succession of intermediate complexes including the ORC-Cdc6-Cdt1-MCM2-7 (OCCM) helicase-loading intermediate, and ends when two MCM2-7 hexamers fully encircle the DNA in a head-to-head orientation. The resulting double hexamer is inactive for DNA unwinding. This process takes place during G1 phase and precedes CMG complex assembly." [PMID:23603117, PMID:25085418, PMID:28191893, PMID:28191894, PMID:28501329]
+comment: The individual ring-loading events within this process are mediated by MCM loader activity (GO:7770122). This term covers the whole multistep process, including formation of the intermediate complexes and the head-to-head association of the two loaded hexamers.
+synonym: "MCM complex loading" EXACT []
 ...
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/16570" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32181" xsd:anyURI
 created_by: pg
...
@@ -494768,7 +495363,7 @@
 ...
 namespace: molecular_function
-def: "A 5'-end triphospho-[mRNA] + H2O = a 5'-end diphospho-[mRNA] + H+ + phosphate." [PMID:9473487]
+def: "Catalysis of the reaction: a 5'-end triphospho-ribonucleoside in mRNA + H2O = a 5'-end diphospho-ribonucleoside in mRNA + phosphate + H+." [PMID:9473487, RHEA:67004]
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32653" xsd:anyURI
 created_by: pg
...
@@ -504808,15 +505416,20 @@
 ...
 [Term]
 id: GO:0160270
-name: phosphatidylserine-phosphatidylinositol-4-phosphate exchange activity
+name: 1-phosphatidyl-1D-myo-inositol 4-phosphate:phosphatidylserine exchange activity
 namespace: molecular_function
...
+synonym: "phosphatidylinositol-4-phosphate-phosphatidylserine exchange activity" EXACT []
+synonym: "phosphatidylinositol-4-phosphate:phosphatidylserine exchange activity" EXACT []
+synonym: "phosphatidylserine-phosphatidylinositol-4-phosphate exchange activity" EXACT []
+synonym: "phosphatidylserine:phosphatidylinositol-4-phosphate exchange activity" EXACT []
 xref: RHEA:81667
...
+name: 1-phosphatidyl-1D-myo-inositol 4-phosphate:cholesterol exchange activity
 namespace: molecular_function
...
+synonym: "cholesterol:phosphatidylinositol-4-phosphate exchange activity" EXACT []
+synonym: "phosphatidylinositol-4-phosphate-cholesterol exchange activity" EXACT []
+synonym: "phosphatidylinositol-4-phosphate:cholesterol exchange activity" EXACT []
 xref: RHEA:84179
...
@@ -533649,13 +534374,15 @@
 ...
 [Term]
 id: GO:1901357
-name: beta-D-galactofuranose catabolic process
+name: obsolete beta-D-galactofuranose catabolic process
 namespace: biological_process
-def: "The chemical reactions and pathways resulting in the breakdown of beta-D-galactofuranose." [GOC:di, GOC:TermGenie]
+def: "OBSOLETE. The chemical reactions and pathways resulting in the breakdown of beta-D-galactofuranose." [GOC:di, GOC:TermGenie]
+comment: This term was obsoleted because there is no evidence that this pathway exists.
 synonym: "beta-D-galactofuranose breakdown" EXACT [GOC:TermGenie]
 synonym: "beta-D-galactofuranose catabolism" EXACT [GOC:TermGenie]
 synonym: "beta-D-galactofuranose degradation" EXACT [GOC:TermGenie]
-is_a: GO:0019388 ! galactose catabolic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32647" xsd:anyURI
+is_obsolete: true
 created_by: di
...
+name: regulation of 'de novo' NAD+ biosynthetic process
 namespace: biological_process
...
+def: "Any process that modulates the frequency, rate or extent of 'de novo' NAD+ biosynthetic process." [GO_REF:0000058, GOC:bf, GOC:PARL, GOC:TermGenie, PMID:12140278, PMID:19843166]
+synonym: "regulation of 'de novo' NAD biosynthetic process" BROAD []
+synonym: "regulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
 is_a: GO:1900371 ! regulation of purine nucleotide biosynthetic process
 is_a: GO:1902688 ! regulation of NAD metabolic process
 intersection_of: GO:0065007 ! biological regulation
-intersection_of: regulates GO:0034354 ! 'de novo' NAD+ biosynthetic process from L-tryptophan
-relationship: regulates GO:0034354 ! 'de novo' NAD+ biosynthetic process from L-tryptophan
+intersection_of: regulates GO:0034628 ! 'de novo' NAD+ biosynthetic process
+relationship: regulates GO:0034628 ! 'de novo' NAD+ biosynthetic process
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/29050" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32206" xsd:anyURI
 created_by: bf
 creation_date: 2016-03-03T10:00:50Z
 
 [Term]
 id: GO:1905013
-name: negative regulation of 'de novo' NAD biosynthetic process from L-tryptophan
+name: negative regulation of 'de novo' NAD+ biosynthetic process
 namespace: biological_process
-def: "Any process that stops, prevents or reduces the frequency, rate or extent of 'de novo' NAD biosynthetic process from L-tryptophan." [GO_REF:0000058, GOC:bf, GOC:PARL, GOC:TermGenie, PMID:12140278, PMID:19843166]
-synonym: "down regulation of 'de novo' NAD biosynthetic process from tryptophan" EXACT [GOC:TermGenie]
-synonym: "down regulation of de novo NAD biosynthetic process from tryptophan" RELATED [GOC:TermGenie]
-synonym: "down-regulation of 'de novo' NAD biosynthetic process from tryptophan" EXACT [GOC:TermGenie]
-synonym: "down-regulation of de novo NAD biosynthetic process from tryptophan" RELATED [GOC:TermGenie]
-synonym: "downregulation of 'de novo' NAD biosynthetic process from tryptophan" EXACT [GOC:TermGenie]
-synonym: "downregulation of de novo NAD biosynthetic process from tryptophan" RELATED [GOC:TermGenie]
-synonym: "inhibition of 'de novo' NAD biosynthetic process from tryptophan" NARROW [GOC:TermGenie]
-synonym: "inhibition of de novo NAD biosynthetic process from tryptophan" RELATED [GOC:TermGenie]
-synonym: "negative regulation of 'de novo' NAD biosynthetic process from tryptophan" BROAD []
...
+def: "Any process that stops, prevents or reduces the frequency, rate or extent of 'de novo' NAD+ biosynthetic process." [GO_REF:0000058, GOC:bf, GOC:PARL, GOC:TermGenie, PMID:12140278, PMID:19843166]
+synonym: "down regulation of 'de novo' NAD biosynthetic process" EXACT [GOC:TermGenie]
+synonym: "down regulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "down-regulation of 'de novo' NAD biosynthetic process" EXACT [GOC:TermGenie]
+synonym: "down-regulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "downregulation of 'de novo' NAD biosynthetic process" EXACT [GOC:TermGenie]
+synonym: "downregulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "inhibition of 'de novo' NAD biosynthetic process" NARROW [GOC:TermGenie]
+synonym: "inhibition of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "negative regulation of 'de novo' NAD biosynthetic process" BROAD []
+synonym: "negative regulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
 is_a: GO:1900372 ! negative regulation of purine nucleotide biosynthetic process
 is_a: GO:1902689 ! negative regulation of NAD metabolic process
-is_a: GO:1905012 ! regulation of 'de novo' NAD biosynthetic process from L-tryptophan
+is_a: GO:1905012 ! regulation of 'de novo' NAD+ biosynthetic process
 intersection_of: GO:0065007 ! biological regulation
-intersection_of: negatively_regulates GO:0034354 ! 'de novo' NAD+ biosynthetic process from L-tryptophan
-relationship: negatively_regulates GO:0034354 ! 'de novo' NAD+ biosynthetic process from L-tryptophan
+intersection_of: negatively_regulates GO:0034628 ! 'de novo' NAD+ biosynthetic process
+relationship: negatively_regulates GO:0034628 ! 'de novo' NAD+ biosynthetic process
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/29050" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32206" xsd:anyURI
 created_by: bf
 creation_date: 2016-03-03T10:01:00Z
 
 [Term]
 id: GO:1905014
-name: positive regulation of 'de novo' NAD biosynthetic process from L-tryptophan
+name: positive regulation of 'de novo' NAD+ biosynthetic process
 namespace: biological_process
-def: "Any process that activates or increases the frequency, rate or extent of 'de novo' NAD biosynthetic process from L-tryptophan." [GO_REF:0000058, GOC:bf, GOC:PARL, GOC:TermGenie]
+def: "Any process that activates or increases the frequency, rate or extent of 'de novo' NAD+ biosynthetic process." [GO_REF:0000058, GOC:bf, GOC:PARL, GOC:TermGenie]
 synonym: "activation of 'de novo' NAD biosynthetic process from tryptophan" NARROW [GOC:TermGenie]
-synonym: "activation of de novo NAD biosynthetic process from tryptophan" RELATED [GOC:TermGenie]
-synonym: "positive regulation of 'de novo' NAD biosynthetic process from tryptophan" BROAD []
-synonym: "positive regulation of de novo NAD biosynthetic process from tryptophan" RELATED [GOC:TermGenie]
-synonym: "up regulation of 'de novo' NAD biosynthetic process from tryptophan" EXACT [GOC:TermGenie]
...
+synonym: "activation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "positive regulation of 'de novo' NAD biosynthetic process" BROAD []
+synonym: "positive regulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "up regulation of 'de novo' NAD biosynthetic process" EXACT [GOC:TermGenie]
+synonym: "up regulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "up-regulation of 'de novo' NAD biosynthetic process" EXACT [GOC:TermGenie]
+synonym: "up-regulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
+synonym: "upregulation of 'de novo' NAD biosynthetic process" EXACT [GOC:TermGenie]
+synonym: "upregulation of de novo NAD biosynthetic process" RELATED [GOC:TermGenie]
...
+is_a: GO:1905012 ! regulation of 'de novo' NAD+ biosynthetic process
 intersection_of: GO:0065007 ! biological regulation
-intersection_of: positively_regulates GO:0034354 ! 'de novo' NAD+ biosynthetic process from L-tryptophan
-relationship: positively_regulates GO:0034354 ! 'de novo' NAD+ biosynthetic process from L-tryptophan
+intersection_of: positively_regulates GO:0034628 ! 'de novo' NAD+ biosynthetic process
+relationship: positively_regulates GO:0034628 ! 'de novo' NAD+ biosynthetic process
 property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/29050" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32206" xsd:anyURI
 created_by: bf
...
@@ -617221,53 +617934,45 @@
 ...
 [Term]
 id: GO:1905749
-name: regulation of endosome to plasma membrane protein transport
+name: obsolete regulation of endosome to plasma membrane protein transport
 namespace: biological_process
-def: "Any process that modulates the frequency, rate or extent of endosome to plasma membrane protein transport." [GO_REF:0000058, GOC:TermGenie, PMID:22869721]
-is_a: GO:0033157 ! regulation of intracellular protein transport
-is_a: GO:1903076 ! regulation of protein localization to plasma membrane
-is_a: GO:2001135 ! regulation of endocytic recycling
-intersection_of: GO:0065007 ! biological regulation
-intersection_of: regulates GO:0099638 ! endosome to plasma membrane protein transport
-relationship: regulates GO:0099638 ! endosome to plasma membrane protein transport
+def: "OBSOLETE. Any process that modulates the frequency, rate or extent of endosome to plasma membrane protein transport." [GO_REF:0000058, GOC:TermGenie, PMID:22869721]
+comment: The reason for obsoletion is that the regulated process GO:0099638 was merged into GO:0032456 endocytic recycling, so this term was merged into GO:2001135 regulation of endocytic recycling.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31237" xsd:anyURI
+is_obsolete: true
+replaced_by: GO:2001135
 created_by: pga
 creation_date: 2016-12-09T13:46:13Z
 
 [Term]
 id: GO:1905750
-name: negative regulation of endosome to plasma membrane protein transport
+name: obsolete negative regulation of endosome to plasma membrane protein transport
 namespace: biological_process
-def: "Any process that stops, prevents or reduces the frequency, rate or extent of endosome to plasma membrane protein transport." [GO_REF:0000058, GOC:TermGenie, PMID:22869721]
+def: "OBSOLETE. Any process that stops, prevents or reduces the frequency, rate or extent of endosome to plasma membrane protein transport." [GO_REF:0000058, GOC:TermGenie, PMID:22869721]
+comment: The reason for obsoletion is that the regulated process GO:0099638 was merged into GO:0032456 endocytic recycling, so this term was merged into GO:2001136 negative regulation of endocytic recycling.
 synonym: "down regulation of endosome to plasma membrane protein transport" EXACT [GOC:TermGenie]
 synonym: "down-regulation of endosome to plasma membrane protein transport" EXACT [GOC:TermGenie]
 synonym: "downregulation of endosome to plasma membrane protein transport" EXACT [GOC:TermGenie]
 synonym: "inhibition of endosome to plasma membrane protein transport" NARROW [GOC:TermGenie]
...
-is_a: GO:1905749 ! regulation of endosome to plasma membrane protein transport
-is_a: GO:2001136 ! negative regulation of endocytic recycling
-intersection_of: GO:0065007 ! biological regulation
-intersection_of: negatively_regulates GO:0099638 ! endosome to plasma membrane protein transport
-relationship: negatively_regulates GO:0099638 ! endosome to plasma membrane protein transport
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31237" xsd:anyURI
+is_obsolete: true
+replaced_by: GO:2001136
 created_by: pga
 creation_date: 2016-12-09T13:46:21Z
 
 [Term]
 id: GO:1905751
-name: positive regulation of endosome to plasma membrane protein transport
+name: obsolete positive regulation of endosome to plasma membrane protein transport
 namespace: biological_process
-def: "Any process that activates or increases the frequency, rate or extent of endosome to plasma membrane protein transport." [GO_REF:0000058, GOC:TermGenie, PMID:22869721]
+def: "OBSOLETE. Any process that activates or increases the frequency, rate or extent of endosome to plasma membrane protein transport." [GO_REF:0000058, GOC:TermGenie, PMID:22869721]
+comment: The reason for obsoletion is that the regulated process GO:0099638 was merged into GO:0032456 endocytic recycling, so this term was merged into GO:2001137 positive regulation of endocytic recycling.
 synonym: "activation of endosome to plasma membrane protein transport" NARROW [GOC:TermGenie]
 synonym: "up regulation of endosome to plasma membrane protein transport" EXACT [GOC:TermGenie]
 synonym: "up-regulation of endosome to plasma membrane protein transport" EXACT [GOC:TermGenie]
 synonym: "upregulation of endosome to plasma membrane protein transport" EXACT [GOC:TermGenie]
...
-is_a: GO:1905749 ! regulation of endosome to plasma membrane protein transport
-is_a: GO:2001137 ! positive regulation of endocytic recycling
-intersection_of: GO:0065007 ! biological regulation
-intersection_of: positively_regulates GO:0099638 ! endosome to plasma membrane protein transport
-relationship: positively_regulates GO:0099638 ! endosome to plasma membrane protein transport
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31237" xsd:anyURI
+is_obsolete: true
...
@@ -625805,12 +626518,16 @@
 ...
 [Term]
 id: GO:1990422
-name: glyoxalase (glycolic acid-forming) activity
+name: glyoxalase (glycolate-forming) activity
 namespace: molecular_function
-def: "Catalysis of the reaction: glyoxal + H2O = glycolic acid. Catalysis occurs in the absence of a cofactor." [GOC:bf, GOC:PARL, PMID:22523093]
+def: "Catalysis of the reaction: glyoxal + H2O = glycolate + H+. Catalysis occurs in the absence of a cofactor." [PMID:22523093, PMID:26678554, RHEA:51672]
+synonym: "glyoxalase (glycolic acid-forming) activity" EXACT []
+xref: RHEA:51672
 is_a: GO:0016836 ! hydro-lyase activity
 relationship: part_of GO:0046295 ! glycolate biosynthetic process
 relationship: part_of GO:1903190 ! glyoxal catabolic process
+property_value: skos:exactMatch RHEA:51672
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32611" xsd:anyURI
 created_by: bf
...
@@ -629270,10 +629987,13 @@
 ...
 [Term]
 id: GO:1990734
-name: astral microtubule anchoring at mitotic spindle pole body
+name: obsolete astral microtubule anchoring at mitotic spindle pole body
 namespace: biological_process
-def: "Any process in which an astral microtubule is maintained in a specific location in a cell by attachment to a mitotic spindle pole body. Microtubules attach to spindle pole bodies at the minus end." [PMID:15004232]
-is_a: GO:0034631 ! microtubule anchoring at spindle pole body
+def: "OBSOLETE. Any process in which an astral microtubule is maintained in a specific location in a cell by attachment to a mitotic spindle pole body. Microtubules attach to spindle pole bodies at the minus end." [PMID:15004232]
+comment: The reason for obsoletion is that this term represents a molecular function.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32155" xsd:anyURI
+is_obsolete: true
+consider: GO:7770121
...
@@ -630050,12 +630772,13 @@
 ...
 [Term]
 id: GO:1990810
-name: microtubule anchoring at mitotic spindle pole body
+name: obsolete microtubule anchoring at mitotic spindle pole body
 namespace: biological_process
-def: "Any process in which a microtubule is maintained in a specific location in a cell by attachment to a mitotic spindle pole body. Microtubules attach to spindle pole bodies at the minus end." [PMID:17486116]
-is_a: GO:0034631 ! microtubule anchoring at spindle pole body
...
+def: "OBSOLETE. Any process in which a microtubule is maintained in a specific location in a cell by attachment to a mitotic spindle pole body. Microtubules attach to spindle pole bodies at the minus end." [PMID:17486116]
+comment: The reason for obsoletion is that this term represents a molecular function.
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32155" xsd:anyURI
+is_obsolete: true
+consider: GO:7770121
...
@@ -647992,35 +648712,39 @@
 ...
 [Term]
 id: GO:2001154
-name: regulation of glycolytic fermentation to ethanol
+name: regulation of pyruvate fermentation to ethanol
 namespace: biological_process
-def: "Any process that modulates the frequency, rate or extent of glucose catabolic process to ethanol." [GOC:obol]
+def: "Any process that modulates the frequency, rate or extent of pyruvate fermentation to ethanol." [GOC:obol]
 synonym: "regulation of ethanol fermentation" EXACT [GOC:obol]
 synonym: "regulation of glucose fermentation to ethanol" EXACT [GOC:obol]
+synonym: "regulation of glycolytic fermentation to ethanol" RELATED []
+is_a: GO:0009894 ! regulation of catabolic process
 is_a: GO:0043465 ! regulation of fermentation
-is_a: GO:0043470 ! regulation of carbohydrate catabolic process
 is_a: GO:0062012 ! regulation of small molecule metabolic process
 intersection_of: GO:0065007 ! biological regulation
 intersection_of: regulates GO:0019655 ! pyruvate fermentation to ethanol
 relationship: regulates GO:0019655 ! pyruvate fermentation to ethanol
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32581" xsd:anyURI
 created_by: mcc
 creation_date: 2011-10-27T02:39:00Z
 
 [Term]
 id: GO:2001155
-name: negative regulation of glycolytic fermentation to ethanol
+name: negative regulation of pyruvate fermentation to ethanol
 namespace: biological_process
-def: "Any process that stops, prevents or reduces the frequency, rate or extent of glucose catabolic process to ethanol." [GOC:obol]
+def: "Any process that stops, prevents or reduces the frequency, rate or extent of pyruvate fermentation to ethanol." [GOC:obol]
 synonym: "negative regulation of ethanol fermentation" EXACT [GOC:obol]
 synonym: "negative regulation of glucose fermentation to ethanol" EXACT [GOC:obol]
+synonym: "negative regulation of glycolytic fermentation to ethanol" RELATED []
...
-is_a: GO:2001154 ! regulation of glycolytic fermentation to ethanol
+is_a: GO:2001154 ! regulation of pyruvate fermentation to ethanol
 intersection_of: GO:0065007 ! biological regulation
 intersection_of: negatively_regulates GO:0019655 ! pyruvate fermentation to ethanol
 relationship: negatively_regulates GO:0019655 ! pyruvate fermentation to ethanol
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32581" xsd:anyURI
 created_by: mcc
...
@@ -648273,17 +648997,19 @@
 ...
 [Term]
 id: GO:2001172
-name: positive regulation of glycolytic fermentation to ethanol
+name: positive regulation of pyruvate fermentation to ethanol
 namespace: biological_process
-def: "Any process that activates or increases the frequency, rate or extent of glucose catabolic process to ethanol." [GOC:obol]
+def: "Any process that activates or increases the frequency, rate or extent of pyruvate fermentation to ethanol." [GOC:obol]
 synonym: "positive regulation of ethanol fermentation" EXACT [GOC:obol]
 synonym: "positive regulation of glucose fermentation to ethanol" EXACT [GOC:obol]
+synonym: "positive regulation of glycolytic fermentation to ethanol" RELATED []
 is_a: GO:0009896 ! positive regulation of catabolic process
 is_a: GO:0062013 ! positive regulation of small molecule metabolic process
-is_a: GO:2001154 ! regulation of glycolytic fermentation to ethanol
+is_a: GO:2001154 ! regulation of pyruvate fermentation to ethanol
 intersection_of: GO:0065007 ! biological regulation
 intersection_of: positively_regulates GO:0019655 ! pyruvate fermentation to ethanol
 relationship: positively_regulates GO:0019655 ! pyruvate fermentation to ethanol
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32581" xsd:anyURI
 created_by: mcc
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32292" xsd:anyURI
 created_by: dragon-ai-agent
...
+[Term]
+id: GO:7770121
+name: microtubule-spindle pole body anchor activity
+namespace: molecular_function
+def: "The binding activity of a molecule that brings together a microtubule and a spindle pole body, in order to maintain the location of the microtubule minus end at the spindle pole body." [PMID:17486116, PMID:25987607]
+comment: This activity may be mediated by direct microtubule binding or indirectly, for example through the gamma-tubulin complex. It does not cover spindle pole body-localized motor proteins that exert force on microtubules without tethering them.
+synonym: "spindle pole body-microtubule anchor activity" EXACT []
+is_a: GO:0140475 ! spindle pole body anchor activity
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32155" xsd:anyURI
+created_by: ai4c-agent
+creation_date: 2026-09-15T17:46:51Z
+
+[Term]
+id: GO:7770122
+name: MCM loader activity
+namespace: molecular_function
+def: "Facilitating the opening of the ring structure of the MCM2-7 complex at the Mcm2-Mcm5 gate and its closing around duplex DNA at a replication origin, driven by ATP hydrolysis." [PMID:23603117, PMID:25085418, PMID:28191893]
+comment: In eukaryotes this activity is carried out by the origin recognition complex (ORC) acting together with Cdc6 and Cdt1, which open the MCM2-7 ring, admit duplex origin DNA and close the ring around it. The loaded single hexamers subsequently associate head-to-head; see MCM double hexamer assembly at replication origin (GO:0140530).
+synonym: "MCM complex loader activity" EXACT []
+synonym: "MCM helicase loader activity" EXACT []
+synonym: "MCM loading activity" EXACT []
+synonym: "MCM2-7 loader activity" EXACT []
...
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32181" xsd:anyURI
+created_by: ai4c-agent
+creation_date: 2026-09-16T17:04:20Z
+
+[Term]
+id: GO:7770123
+name: refolding-mediated fusogenic activity
+namespace: molecular_function
+def: "The activity of joining two lipid bilayers to form a single membrane, driven by a large refolding transition of an already-folded, metastable protein anchored in one of the two membranes, which inserts a hydrophobic segment into the target membrane and then collapses, bending both bilayers into a stalk and a fusion pore." [PMID:25866377, PMID:28235200]
+comment: Covers the three structural classes of viral fusion protein and their cellular relatives, such as the gamete fusogen HAP2/GCS1. The protein is first rendered metastable by a priming event and is then triggered to refold into its lower-energy postfusion conformation; the energy released by that refolding is what overcomes the bilayer merger barrier. Contrast with helical-bundle zippering fusogenic activity (GO:0005484), where the bundle is assembled de novo from motifs contributed by proteins in both apposed membranes rather than refolded from a single pre-folded protein. Class I viral fusion proteins also finish as a helical bundle, but belong here rather than under GO:0005484.
+synonym: "refolding-driven fusogenic activity" EXACT []
+is_a: GO:0140522 ! fusogenic activity
+relationship: part_of GO:0061025 ! membrane fusion
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/31789" xsd:anyURI
+created_by: ai4c-agent
+creation_date: 2026-09-16T23:52:19Z
+
+[Term]
+id: GO:7770124
+name: 1-phosphatidyl-1D-myo-inositol 4,5-bisphosphate:cholesterol exchange activity
+namespace: molecular_function
+def: "Catalysis of the reaction: a 1,2-diacyl-sn-glycero-3-phospho-(1D-myo-inositol 4,5-bisphosphate)(out) + cholesterol(in) = a 1,2-diacyl-sn-glycero-3-phospho-(1D-myo-inositol 4,5-bisphosphate)(in) + cholesterol(out). This reaction results in the exchange of cholesterol for phosphatidylinositol-4,5-bisphosphate (PI(4,5)P2) between membranes." [PMID:30581148, PMID:34124795, RHEA:84879]
+synonym: "cholesterol-1-phosphatidyl-1D-myo-inositol 4,5-bisphosphate exchange activity" EXACT []
+synonym: "cholesterol-PIP2 antiporter activity" RELATED []
+synonym: "cholesterol/PI(4,5)P2 exchange activity" EXACT []
+synonym: "cholesterol:PI(4,5)P2 counter-transport activity" EXACT []
+synonym: "phosphatidylinositol-4,5-bisphosphate:cholesterol exchange activity" EXACT []
+synonym: "sterol/PI(4,5)P2 exchange activity" BROAD []
+xref: RHEA:84879
+xref: RHEA:84883
+is_a: GO:0120014 ! phospholipid transfer activity
+is_a: GO:0120020 ! cholesterol transfer activity
+is_a: GO:7770011 ! lipid exchange activity
+property_value: skos:exactMatch RHEA:84879
+property_value: skos:narrowMatch RHEA:84883
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32622" xsd:anyURI
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32633" xsd:anyURI
+created_by: ai4c-agent
...
+[Term]
+id: GO:7770126
+name: mitochondrial protein biosynthetic process
+namespace: biological_process
+def: "The chemical reactions and pathways resulting in the formation of a protein, taking place in a mitochondrion. This comprises the charging of mitochondrial tRNAs by mitochondrial aminoacyl-tRNA synthetases and the mitoribosome-mediated translation of mitochondrially encoded mRNAs." [PMID:38855161, PMID:42498773]
+synonym: "mitochondrial protein biosynthesis" EXACT []
+synonym: "mitochondrial protein synthesis" EXACT []
+is_a: GO:0160307 ! protein biosynthetic process
+intersection_of: GO:0160307 ! protein biosynthetic process
+intersection_of: occurs_in GO:0005739 ! mitochondrion
+relationship: occurs_in GO:0005739 ! mitochondrion
+relationship: part_of GO:0140053 ! mitochondrial gene expression
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32629" xsd:anyURI
+created_by: ai4c-agent
+creation_date: 2026-09-19T00:49:21Z
+
+[Term]
+id: GO:7770127
+name: cytosolic protein biosynthetic process
+namespace: biological_process
+def: "The chemical reactions and pathways resulting in the formation of a protein, taking place in the cytosol. This comprises the charging of cytosolic tRNAs by cytosolic aminoacyl-tRNA synthetases and the translation of mRNA by cytosolic ribosomes." [PMID:35278792, PMID:42399431]
+synonym: "cytoplasmic protein biosynthetic process" BROAD []
+synonym: "cytoplasmic protein synthesis" BROAD []
+synonym: "cytosolic protein biosynthesis" EXACT []
+synonym: "cytosolic protein synthesis" EXACT []
+is_a: GO:0160307 ! protein biosynthetic process
+intersection_of: GO:0160307 ! protein biosynthetic process
+intersection_of: occurs_in GO:0005829 ! cytosol
+relationship: occurs_in GO:0005829 ! cytosol
...
+[Term]
+id: GO:7770128
+name: tRNA aminoacylation for cytosolic protein translation
+namespace: biological_process
+def: "The synthesis of aminoacyl tRNA by the formation of an ester bond between the 3'-hydroxyl group of the most 3' adenosine of the tRNA and the alpha carboxylic acid group of an amino acid, to be used in ribosome-mediated polypeptide synthesis in the cytosol." [PMID:35278792]
+synonym: "tRNA aminoacylation for cytoplasmic protein translation" EXACT []
+is_a: GO:0006418 ! tRNA aminoacylation for protein translation
+relationship: occurs_in GO:0005829 ! cytosol
+relationship: part_of GO:7770127 ! cytosolic protein biosynthetic process
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32629" xsd:anyURI
...
+[Term]
+id: GO:7770129
+name: spermatid residual body
+namespace: cellular_component
+def: "A membrane-bounded, anucleate mass of cytoplasm that is separated from one or more developing male germ cells during spermatogenesis and discarded. The residual body receives most of the cytoplasm and organelles not required by the spermatid or spermatozoon, such as ribosomes, endoplasmic reticulum, Golgi, and excess cytoskeletal components, and is subsequently degraded, typically by phagocytosis by somatic cells of the gonad (e.g. Sertoli cells in vertebrates, gonadal sheath cells in nematodes) or by extrusion into the reproductive tract." [PMID:12591244, PMID:3995554, PMID:7298721]
+comment: The "waste bag" of Drosophila spermatogenesis, a cyst-level structure formed during sperm individualization that collects the discarded cytoplasm and organelles from the 64 spermatids of a syncytial cyst, is considered a narrow variant of this term.
+synonym: "cytoplasmic residual body" EXACT []
+synonym: "residual body" BROAD []
+synonym: "spermatogenic residual body" EXACT []
+synonym: "waste bag" NARROW []
+is_a: GO:0110165 ! cellular anatomical structure
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32651" xsd:anyURI
+created_by: ai4c-agent
+creation_date: 2026-09-23T16:08:11Z
+
+[Term]
+id: GO:7770130
...
+synonym: "NAD(P)HX repair system" EXACT []
+synonym: "NADHX repair" NARROW []
+synonym: "NADHX/NADPHX repair" EXACT []
+synonym: "NADPHX repair" NARROW []
+synonym: "nicotinamide nucleotide repair" RELATED [PMID:21994945]
+is_a: GO:0006163 ! purine nucleotide metabolic process
+is_a: GO:0072524 ! pyridine-containing compound metabolic process
+is_a: GO:0110051 ! metabolite repair
+property_value: term_tracker_item "https://github.com/geneontology/go-ontology/issues/32663" xsd:anyURI
+created_by: ai4c-agent
+creation_date: 2026-09-25T00:10:15Z
+
 [Typedef]
 id: ends_during
 name: ends during
