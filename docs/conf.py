...
latex_documents = [
  ('index', 'go-ontology.tex', u'go-ontology Documentation',
   u'go-ontology', 'manual'),
]
...
man_pages = [
    ('index', 'go-ontology', u'go-ontology Documentation',
     [u'go-ontology'], 1)
]
...
texinfo_documents = [
  ('index', 'go-ontology', u'go-ontology Documentation',
   u'go-ontology', 'go-ontology', 'One line description of project.',
   'Miscellaneous'),
]
